...
export default function TweetDetailView({ tweet }: TweetDetailViewProps) {
  return (
      ...
      <div className="p-4">
        ...
        <div className="mb-4 border-b border-gray-200 pb-4 dark:border-gray-800">
          <p className="text-sm text-gray-500">
            {tweet.date} · From LG Smart Fridge
          </p>
        </div>
        ...
        <div className="mb-4 flex justify-around border-b border-gray-200 pb-4 text-gray-500 dark:border-gray-800">
          ...
          />
          <Repeat2 size={24} className="cursor-pointer hover:text-green-500" />
