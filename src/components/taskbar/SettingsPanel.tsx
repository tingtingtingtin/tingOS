    ...
    <div
      ...
      className={
        isMobile
          ...
          : "absolute right-0 bottom-14 z-50 w-64 rounded-lg border border-gray-200 bg-white/95 p-4 text-gray-900 shadow-2xl backdrop-blur-md dark:border-gray-700 dark:bg-gray-800/95 dark:text-white"
      }
    >
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between">
          ...
          >
            ...
            />
            <div
              className={`absolute top-1 bottom-1 left-1 w-7 rounded-full bg-white shadow-sm transition-transform dark:bg-gray-500 ${
